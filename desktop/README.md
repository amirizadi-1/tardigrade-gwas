# Tardigrade Desktop Application

This directory contains the PySide6 desktop interface for Tardigrade Multi-GWAS Explorer.
...
For the complete contribution statement, see [CONTRIBUTORS.md](../CONTRIBUTORS.md).
